...
![]({{ site.url }}/images/2017-05-16-bayesian-estimation-in-action/unnamed-chunk-2-1.png)
...
![]({{ site.url }}/images/2017-05-16-bayesian-estimation-in-action/unnamed-chunk-6-1.png)
...
Lets take a look at the `stan-samples` object.
    ...
    ## rate   0.09    0.00 0.03   0.04   0.07   0.09   0.11   0.15  2493    1
    ## lp__ -30.97    0.02 0.75 -33.10 -31.14 -30.69 -30.50 -30.44  2000    1
    ## 
    ## Samples were drawn using NUTS(diag_e) at Tue May 16 16:11:14 2017.
...
![]({{ site.url }}/images/2017-05-16-bayesian-estimation-in-action/unnamed-chunk-11-1.png)
...
![]({{ site.url }}/images/2017-05-16-bayesian-estimation-in-action/unnamed-chunk-12-1.png)
